...
$(document).ready(function(){
    ...
    <a href="{{ route('displayReceiver', $receiverlist->id) }}" style="color: white; background:#000066; border-radius: 3px; height:3px; 
...
<div class="card-body">
        @csrf
            ...
            <button class="btn btn-primary" style="float: right; background:#000066;" type="button" data-bs-toggle="modal" data-bs-target="#confirmUpdate"  data-id="{{ $receiverlist->id }}" data-name="{{ $receiverlist->fullname }}">Update</button>
             <!-- modal -->
